export const projects = [
    ...
    },
    {
        ...
        content: [
            ...
            },
            {
                ...
                pd: 'pd-t-sm',
                img: [
                    {src: '/images/projects/aiSearch/banner/Banner-',
                    alt: 'Intelligent Sustainability Search home page on a desktop monitor and laptop.'},
                ],
            },
            {
                block: 'txt',
            ...
            },
            {
                ...
                pd: 'pd-tb-sm',
                img: [
                    {src: '/images/projects/aiSearch/concept/Concept-',
                    alt: 'Different features of the search tool connected via arrows.'},
                ],
            },
            {
                block: 'txt',
            ...
            },
            {
                ...
                pd: undefined,
                img: [
                    {src: '/images/projects/aiSearch/ui/UI-Search-',
                    alt: 'A laptop displaying search results of the Intelligent Sustainability Search.'},
                ],
            },
            {
                block: 'img',
                ...
                pd: 'pd-t-sm',
                img: [
                    {src: '/images/projects/aiSearch/ui/UI-LCA-',
                    alt: 'A laptop displaying life-cycle-analysis data of a selected product.'},
                    {src: '/images/projects/aiSearch/ui/UI-Tablet-',
                    alt: '3 tablets displaying different search results and functionalities of the Intelligent Sustainability Search.'},
                ],
            },
            {
                block: 'img',
                ...
                pd: 'pd-t-sm',
                img: [
                    {src: '/images/projects/aiSearch/ui/UI-Recycle-',
                    alt: 'A laptop displaying the recyclability checker tool of the Intelligent Sustainability Search.'},
                ],
            },
            {
                block: 'txt',
    ...
    },
    {
        ...
        preview: {
            ...
            imgAlt: 'A person designing a packaging solution on a laptop.',
            dark: true,
        },
        content: [
            {
            ...
            },
            {
                ...
                pd: 'pd-b-lg',
                img: [
                    {src: '/images/projects/packTools/designer/Home-',
                    alt: 'View of the packaging catalogue and home page on a laptop and desktop monitor.'},
                ],
            },
            {
                block: 'img',
                ...
                pd: 'pd-t-sm',
                img: [
                    {src: '/images/projects/packTools/designer/Editor-',
                    alt: 'Two large monitors showing the 3D editing tools (AR view and color application).'},
                ],
            },
            {
                block: 'img',
                ...
                pd: 'pd-t-lg pd-b-sm',
                img: [
                    {src: '/images/projects/packTools/designer/Tablet-',
                    alt: '3D editor view on a tablet device.'},
                ],
            },
            {
                block: 'txt',
            ...
            },
            {
                ...
                pd: 'pd-b-lg',
                img: [
                    {src: '/images/projects/packTools/simulator/Tablet-',
                    alt: 'Packaging layout editor view on a tablet device.'},
                ],
            },
            {
                block: 'img',
                ...
                pd: 'pd-t-sm',
                img: [
                    {src: '/images/projects/packTools/simulator/Results-',
                    alt: 'Pressure test result visualisations on large monitors.'},
                ],
            },
            {
                block: 'img',
                ...
                pd: 'pd-t-lg pd-b-sm',
                img: [
                    {src: '/images/projects/packTools/simulator/Queue-',
                    alt: 'Two laptops showing test queue and home screen designs.'},
                ],
            },
            {
                block: 'txt',
    ...
    },
    {
        ...
        preview: {
            ...
            imgAlt: 'Birds-eye view of a logistic terminal.',
            dark: true,
        },
        content: [
            {
